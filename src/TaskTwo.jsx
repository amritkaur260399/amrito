...
const TaskTwo = () => {
  ...
  const arrowdown = <svg  height="22"
    width="22" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M169.4 470.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 370.8 224 64c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 306.7L54.6 265.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z"/></svg>
  const arrowup=<svg  height="22"
  width="22" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M214.6 41.4c-12.5-12.5-32.8-12.5-45.3 0l-160 160c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L160 141.2V448c0 17.7 14.3 32 32 32s32-14.3 32-32V141.2L329.4 246.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3l-160-160z"/></svg>
  const del = (
    <svg
      height="22"
      width="22"
      ...
      <div className="content p-4">
          ...
          <nav className="flex justify-between">
            ...
            <div className="right flex mr-4">
              ...
              <button
                ...
                onClick={() => {
                  setSearchcnt(api.find((val) => val.id == search));
        ...
        {/* {infoo === true ? (
          <div
            className={
              infoo == true
                ? `flex justify-center mt-4 blur-none`
                    ...
                    <div className="outer">
                      ...
                      >
                        ...
                        <div className="right mr-8 flex w-[17%] justify-between ">
                          ...
                          >
                            {changeIcon== false? arrowdown:arrowup}
                          </span>
                          <span
                      ...
                      {changeIcon == true && infodata.id == val.id ? (
                        <div className="moreinfo text-white bg-slate-800 rounded-2xl mb-4 shadow-xl p-4 text-sm">
                          {infodata.body}
                        </div>
                      ) : (
                        <div className=""></div>
